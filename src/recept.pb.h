...
#define CocktailSetup_init_default               {0, {Liquid_init_default, Liquid_init_default, Liquid_init_default, Liquid_init_default, Liquid_init_default, Liquid_init_default, Liquid_init_default, Liquid_init_default}}
#define Liquid_init_default                      {"", 0}
#define Ingredient_init_zero                     {"", 0}
#define Recept_init_zero                         {"", {{NULL}, NULL}}
#define CocktailSetup_init_zero                  {0, {Liquid_init_zero, Liquid_init_zero, Liquid_init_zero, Liquid_init_zero, Liquid_init_zero, Liquid_init_zero, Liquid_init_zero, Liquid_init_zero}}
